...
extern enum rtk_ve1_chip_type g_chip_type;
...
typedef struct vpu_drv_context_t {
	...
	bool is_decoding_active;
	struct vpudrv_pwr_pair_t *tbl;
	int tbl_cnt;
} vpu_drv_context_t;
...
extern vpudrv_buffer_t *rtk_ve1_get_instance_pool(void);
extern vpudrv_buffer_t *rtk_ve1_get_common_memory(void);
extern vpudrv_buffer_t *rtk_ve1_get_vpu_register(void);
extern vpudrv_buffer_t *rtk_ve1_get_bond_register(void);
extern vpudrv_buffer_t *rtk_ve1_get_dc_register(void);
extern vpudrv_buffer_t *rtk_ve1_get_dmc_register(void);
#ifdef VPU_SUPPORT_RESERVED_VIDEO_MEMORY
extern vpudrv_buffer_t vpu_get_video_memory(void);
#endif /* VPU_SUPPORT_RESERVED_VIDEO_MEMORY */

extern void rtk_ve1_sem_up(void);
extern int rtk_ve1_down_interruptible(void);
extern void rtk_ve1_clock_getting(vpu_clock_info_t *clockInfo);
extern void rtk_ve1_add_vbp_list(vpudrv_buffer_pool_t *vbp, struct file *filp);
extern int rtk_ve1_open_inst(vpudrv_inst_info_t *inst_info, struct file *filp);
extern void rtk_ve1_close_inst(vpudrv_inst_info_t *inst_info);
extern void rtk_ve1_get_inst_num(vpudrv_inst_info_t *inst_info);
extern void rtk_ve1_get_total_inst_num(vpudrv_inst_info_t *inst_info);
extern void rtk_ve1_free_mem(vpudrv_buffer_t *vb);
extern int rtk_ve1_wait_init(vpu_drv_context_t *dev, vpudrv_intr_info_t *info);
extern int rtk_ve1_alloc_from_vm(void);
extern int rtk_ve1_alloc_from_dmabuffer2(void);
extern int rtk_ve1_alloc_dma_buffer(vpudrv_buffer_t *vb);
extern void rtk_ve1_free_dma_buffer(vpudrv_buffer_t *vb);
extern void rtk_ve1_free_dma_buffer_base(vpudrv_buffer_t *vb);
